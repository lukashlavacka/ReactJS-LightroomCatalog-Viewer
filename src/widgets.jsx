...
import { FilterCamera, FilterLens, FilterFlag, FilterFace, FilterColor, FilterFocalLength, FilterISORating, FilterAperture, FilterRating, FilterShutter, FilterDate } from './filter'
import ChartViewer from './chart'
import PhotoStats from './stats'
import TableViewer from './table'

var ReactGridLayout = WidthProvider(ReactGridLayoutWithoutProvider)
...
export default class WidgetLayout extends React.Component {
    ...
    handleMinifyWidget(widget) {
        ...
        _.forEach(newLayout, (w) => { w.y += w.h > 1 ? 1 : 0})
